            ...
            <div class="col-lg-12 text-center">
                <div class="footer-menu ab-sm-15">
                    <ul class="list-unstyled social-icon mb-0">
                        ...
                        <li class="list-inline-item"><a href="https://wa.me/message/WD3CZLXRQWMCA1" target="_blank"><i class="fab fa-whatsapp" ></i></a></li>
                        <li class="list-inline-item"><a href="https://instagram.com/easegroupsd" target="_blank"><i class="fab fa-instagram"></i></a></li>
